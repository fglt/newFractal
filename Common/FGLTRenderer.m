...
@property (nonatomic, strong) id<MTLTexture> escapeTimeTexture;
...
- (void)buildComputeResources
{
    ...
    _escapeTimeTexture = [_device newTextureWithDescriptor:descriptor];
    _escapeTimeTexture.label = @"escapeTime State";
}
...
- (void)encodeComputeWorkInBuffer:(id<MTLCommandBuffer>)commandBuffer
{
    ...
    [commandEncoder setTexture:_escapeTimeTexture atIndex:0];
...
- (void)encodeRenderWorkInBuffer:(id<MTLCommandBuffer>)commandBuffer
{
    ...
    if(renderPassDescriptor != nil)
    {
        ...
        [renderEncoder setFragmentTexture:_escapeTimeTexture atIndex:0];
